...
class GridSearch:
    ...
    def save_results(self, filename):
        ...
        final_results_df["rank_test_score"] = final_results_df["mean_test_score"].rank(ascending=False, method="min")
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=["CricketX", "CricketY", "CricketZ", "Beef", "ArrowHead", "ECG200", "ItalyPowerDemand", "Chinatown"],
